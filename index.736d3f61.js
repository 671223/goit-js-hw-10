/* Notiflix (https://notiflix.github.io) - Version: 3.2.7 - Author: Furkan (https://github.com/furcan) - Copyright 2019 - 2024 Notiflix, MIT License (https://opensource.org/licenses/MIT) */ (function(t, e) {
    ...
    var e1, a1, n1, i1, o1, s1 = "\n\nVisit documentation page to learn more: https://notiflix.github.io/documentation", r1 = '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif', l1 = {
        ...
        for(var n = function n(a) {
            for(var n2 in a)Object.prototype.hasOwnProperty.call(a, n2) && (_$t[n2] = e && "[object Object]" === Object.prototype.toString.call(a[n2]) ? v(_$t[n2], a[n2]) : a[n2]);
        ...
        var f = a1[e.toLocaleLowerCase("en")];
        "string" != typeof n && (n = "Notiflix " + e), "string" != typeof i && (e === m1.Success ? i = '"Do not try to become a person of success but try to become a person of value." <br><br>- Albert Einstein' : e === m1.Failure ? i = '"Failure is simply the opportunity to begin again, this time more intelligently." <br><br>- Henry Ford' : e === m1.Warning ? i = '"The peoples who want to live comfortably without producing and fatigue; they are doomed to lose their dignity, then liberty, and then independence and destiny." <br><br>- Mustafa Kemal Ataturk' : e === m1.Info && (i = '"Knowledge rests not upon truth alone, but upon error also." <br><br>- Carl Gustav Jung')), "string" != typeof o && (o = "Okay"), a1.plainText && (n = N(n), i = N(i), o = N(o)), a1.plainText || (n.length > a1.titleMaxLength && (n = "Possible HTML Tags Error", i = 'The "plainText" option is "false" and the title content length is more than the "titleMaxLength" option.', o = "Okay"), i.length > a1.messageMaxLength && (n = "Possible HTML Tags Error", i = 'The "plainText" option is "false" and the message content length is more than the "messageMaxLength" option.', o = "Okay"), o.length > a1.buttonMaxLength && (n = "Possible HTML Tags Error", i = 'The "plainText" option is "false" and the button content length is more than the "buttonMaxLength" option.', o = "Okay")), n.length > a1.titleMaxLength && (n = n.substring(0, a1.titleMaxLength) + "..."), i.length > a1.messageMaxLength && (i = i.substring(0, a1.messageMaxLength) + "..."), o.length > a1.buttonMaxLength && (o = o.substring(0, a1.buttonMaxLength) + "..."), a1.cssAnimation || (a1.cssAnimationDuration = 0);
        ...
        var b = "";
        if (e === m1.Success ? b = C(a1.svgSize, f.svgColor) : e === m1.Failure ? b = z(a1.svgSize, f.svgColor) : e === m1.Warning ? b = S(a1.svgSize, f.svgColor) : e === m1.Info && (b = L(a1.svgSize, f.svgColor)), x.innerHTML = g + '<div class="' + a1.className + "-content" + (a1.cssAnimation ? " nx-with-animation " : "") + " nx-" + a1.cssAnimationStyle + '" style="width:' + a1.width + "; background:" + a1.backgroundColor + "; animation-duration:" + a1.cssAnimationDuration + 'ms;"><div style="width:' + a1.svgSize + "; height:" + a1.svgSize + ';" class="' + a1.className + '-icon">' + b + '</div><h5 class="' + a1.className + '-title" style="font-weight:500; font-size:' + a1.titleFontSize + "; color:" + f.titleColor + ';">' + n + '</h5><p class="' + a1.className + '-message" style="font-size:' + a1.messageFontSize + "; color:" + f.messageColor + ';">' + i + '</p><a id="NXReportButton" class="' + a1.className + '-button" style="font-weight:500; font-size:' + a1.buttonFontSize + "; background:" + f.buttonBackground + "; color:" + f.buttonColor + ';">' + o + "</a></div>", !t1.document.getElementById(x.id)) {
            ...
            var y = function y() {
                ...
                var _$n = setTimeout(function() {
                    null !== _$e.parentNode && _$e.parentNode.removeChild(_$e), clearTimeout(_$n);
        ...
        return null;
    }, j = function j(e, a, i, o, s, l, c, m, p) {
        if (!k("body")) return !1;
        n1 || G.Confirm.init({});
        var x = v(!0, n1, {});
        "object" != typeof p || Array.isArray(p) || (n1 = v(!0, n1, p)), "string" != typeof a && (a = "Notiflix Confirm"), "string" != typeof i && (i = "Do you agree with me?"), "string" != typeof s && (s = "Yes"), "string" != typeof l && (l = "No"), "function" != typeof c && (c = void 0), "function" != typeof m && (m = void 0), n1.plainText && (a = N(a), i = N(i), s = N(s), l = N(l)), n1.plainText || (a.length > n1.titleMaxLength && (a = "Possible HTML Tags Error", i = 'The "plainText" option is "false" and the title content length is more than "titleMaxLength" option.', s = "Okay", l = "..."), i.length > n1.messageMaxLength && (a = "Possible HTML Tags Error", i = 'The "plainText" option is "false" and the message content length is more than "messageMaxLength" option.', s = "Okay", l = "..."), (s.length || l.length) > n1.buttonsMaxLength && (a = "Possible HTML Tags Error", i = 'The "plainText" option is "false" and the buttons content length is more than "buttonsMaxLength" option.', s = "Okay", l = "...")), a.length > n1.titleMaxLength && (a = a.substring(0, n1.titleMaxLength) + "..."), i.length > n1.messageMaxLength && (i = i.substring(0, n1.messageMaxLength) + "..."), s.length > n1.buttonsMaxLength && (s = s.substring(0, n1.buttonsMaxLength) + "..."), l.length > n1.buttonsMaxLength && (l = l.substring(0, n1.buttonsMaxLength) + "..."), n1.cssAnimation || (n1.cssAnimationDuration = 0);
        var g = t1.document.createElement("div");
        ...
        if (g.innerHTML = b + '<div class="' + n1.className + '-content" style="width:' + n1.width + "; background:" + n1.backgroundColor + "; animation-duration:" + n1.cssAnimationDuration + "ms; border-radius: " + n1.borderRadius + ';"><div class="' + n1.className + '-head"><h5 style="color:' + n1.titleColor + ";font-size:" + n1.titleFontSize + ';">' + a + '</h5><div style="color:' + n1.messageColor + ";font-size:" + n1.messageFontSize + ';">' + i + h + '</div></div><div class="' + n1.className + '-buttons"><a id="NXConfirmButtonOk" class="nx-confirm-button-ok' + ("function" == typeof c ? "" : " nx-full") + '" style="color:' + n1.okButtonColor + ";background:" + n1.okButtonBackground + ";font-size:" + n1.buttonsFontSize + ';">' + s + "</a>" + y + "</div></div>", !t1.document.getElementById(g.id)) {
            ...
            if (A && (A.focus(), A.setSelectionRange(0, (A.value || "").length), A.addEventListener("keyup", function(t) {
                var _$a = t.target.value;
                if (e === d1.Ask && _$a !== w) t.preventDefault(), A.classList.add("nx-validation-failure"), A.classList.remove("nx-validation-success");
                else {
                ...
                if (e === d1.Ask && w && A) {
                    var _$a = (A.value || "").toString();
                    if (_$a !== w) return A.focus(), A.classList.add("nx-validation-failure"), t.stopPropagation(), t.preventDefault(), t.returnValue = !1, t.cancelBubble = !0, !1;
                ...
                var _$i = setTimeout(function() {
                    null !== L.parentNode && (L.parentNode.removeChild(L), clearTimeout(_$i));
        ...
        if ("string" == typeof a && 0 < a.length && (m = a), o) {
            ...
            var d = "";
            if (e === x1.Standard) d = I(i1.svgSize, i1.svgColor);
            else if (e === x1.Hourglass) d = A(i1.svgSize, i1.svgColor);
            else if (e === x1.Circle) d = M(i1.svgSize, i1.svgColor);
            else if (e === x1.Arrows) d = X(i1.svgSize, i1.svgColor);
                ...
                if (e === x1.Custom && (null === i1.customSvgUrl || null === i1.customSvgCode)) return y('You have to set a static SVG url to "customSvgUrl" option to use Loading Custom.'), !1;
                d = D(i1.svgSize, "#f8f8f8", "#32c682");
            }
            ...
            if (w.id = g1.ID, w.className = i1.className + (i1.cssAnimation ? " nx-with-animation" : "") + (i1.clickToClose ? " nx-loading-click-to-close" : ""), w.style.zIndex = i1.zindex, w.style.background = i1.backgroundColor, w.style.animationDuration = i1.cssAnimationDuration + "ms", w.style.fontFamily = '"' + i1.fontFamily + '", ' + r1, w.style.display = "flex", w.style.flexWrap = "wrap", w.style.flexDirection = "column", w.style.alignItems = "center", w.style.justifyContent = "center", i1.rtl && (w.setAttribute("dir", "rtl"), w.classList.add("nx-rtl-on")), w.innerHTML = h + p, !t1.document.getElementById(w.id) && (t1.document.body.appendChild(w), i1.clickToClose)) {
                ...
                C.addEventListener("click", function() {
                    ...
                    var _$t = setTimeout(function() {
                        null !== w.parentNode && (w.parentNode.removeChild(w), clearTimeout(_$t));
        ...
        if (Array.isArray(n)) {
            ...
            var p = t1.document.querySelectorAll(n);
        ...
        if ("object" == typeof i && !Array.isArray(i) || "object" == typeof s && !Array.isArray(s)) {
            var f = {};
            "object" == typeof i ? f = i : "object" == typeof s && (f = s), o1 = v(!0, o1, f);
        }
        var x = "";
        "string" == typeof i && 0 < i.length && (x = i), o1.cssAnimation || (o1.cssAnimationDuration = 0);
        var g = b1.className;
        ...
        if (e2) {
            for(var S, L = [
                ...
                if (1 > T.length) {
                    var F = "";
                    a && (a === u1.Hourglass ? F = A(o1.svgSize, o1.svgColor) : a === u1.Circle ? F = M(o1.svgSize, o1.svgColor) : a === u1.Arrows ? F = X(o1.svgSize, o1.svgColor) : a === u1.Dots ? F = R(o1.svgSize, o1.svgColor) : a === u1.Pulse ? F = B(o1.svgSize, o1.svgColor) : F = I(o1.svgSize, o1.svgColor));
                    ...
                    if (K || 0 < q.length) {
                        if (!k("head")) return !1;
                        K && (Q1 = "position:relative!important;");
                        var J = '<style id="Style-' + b1.ID + "-" + U + '">' + Y + "." + z + "{" + Q1 + q + "}</style>", Z = t1.document.createRange();
            ...
            var _$a = setTimeout(function() {
                ...
                var _$n = e.getAttribute("id"), _$i = t1.document.getElementById("Style-" + _$n);
                _$i && null !== _$i.parentNode && _$i.parentNode.removeChild(_$i), clearTimeout(_$a);
            }, o1.cssAnimationDuration);
        }, tt = function tt(t) {
            if (t && 0 < t.length) for(var _$e, _$a = 0; _$a < t.length; _$a++)_$e = t[_$a], _$e && (_$e.classList.add("nx-remove"), _(_$e));
            ...
            for(var _$t, _$e = 0; _$e < C; _$e++)_$t = c[_$e], _$t && (et(_$t), T = _$t.querySelectorAll("[id^=" + b1.ID + "]"), tt(T));
            clearTimeout(at);
        }, l);
        o1 = v(!0, o1, d);
    }, G = {
        Notify: {
            init: function init(t) {
                e1 = v(!0, c1, t), w(T, "NotiflixNotifyInternalCSS");
            },
            merge: function merge(t) {
                return e1 ? void (e1 = v(!0, e1, t)) : (y("You have to initialize the Notify module before call Merge function."), !1);
            },
            success: function success(t, e, a) {
                E(l1.Success, t, e, a);
            },
            failure: function failure(t, e, a) {
                E(l1.Failure, t, e, a);
            },
            warning: function warning(t, e, a) {
                E(l1.Warning, t, e, a);
            },
            info: function info(t, e, a) {
                E(l1.Info, t, e, a);
            }
        },
        Report: {
            init: function init(t) {
                a1 = v(!0, p1, t), w(O, "NotiflixReportInternalCSS");
            },
            merge: function merge(t) {
                return a1 ? void (a1 = v(!0, a1, t)) : (y("You have to initialize the Report module before call Merge function."), !1);
            },
            success: function success(t, e, a, n, i) {
                H(m1.Success, t, e, a, n, i);
            },
            failure: function failure(t, e, a, n, i) {
                H(m1.Failure, t, e, a, n, i);
            },
            warning: function warning(t, e, a, n, i) {
                H(m1.Warning, t, e, a, n, i);
            },
            info: function info(t, e, a, n, i) {
                H(m1.Info, t, e, a, n, i);
            }
        },
        Confirm: {
            init: function init(t) {
                n1 = v(!0, f1, t), w(W, "NotiflixConfirmInternalCSS");
            },
            merge: function merge(t) {
                return n1 ? void (n1 = v(!0, n1, t)) : (y("You have to initialize the Confirm module before call Merge function."), !1);
            },
            show: function show(t, e, a, n, i, o, s) {
                j(d1.Show, t, e, null, a, n, i, o, s);
            },
            ask: function ask(t, e, a, n, i, o, s, r) {
                j(d1.Ask, t, e, a, n, i, o, s, r);
            },
            prompt: function prompt(t, e, a, n, i, o, s, r) {
                j(d1.Prompt, t, e, a, n, i, o, s, r);
            }
        },
        Loading: {
            init: function init(t) {
                i1 = v(!0, g1, t), w(P, "NotiflixLoadingInternalCSS");
            },
            merge: function merge(t) {
                return i1 ? void (i1 = v(!0, i1, t)) : (y("You have to initialize the Loading module before call Merge function."), !1);
            },
            standard: function standard(t, e) {
                V(x1.Standard, t, e, !0, 0);
            },
            hourglass: function hourglass(t, e) {
                V(x1.Hourglass, t, e, !0, 0);
            },
        ...
        Block: {
            init: function init(t) {
                o1 = v(!0, b1, t), w(Y, "NotiflixBlockInternalCSS");
            },
            merge: function merge(t) {
                return o1 ? void (o1 = v(!0, o1, t)) : (y('You have to initialize the "Notiflix.Block" module before call Merge function.'), !1);
            },
            standard: function standard(t, e, a) {
                Q(!0, u1.Standard, t, e, a);
            },
            hourglass: function hourglass(t, e, a) {
                Q(!0, u1.Hourglass, t, e, a);
            },
            circle: function circle(t, e, a) {
                Q(!0, u1.Circle, t, e, a);
            },
            arrows: function arrows(t, e, a) {
                Q(!0, u1.Arrows, t, e, a);
            },
            dots: function dots(t, e, a) {
                Q(!0, u1.Dots, t, e, a);
            },
            pulse: function pulse(t, e, a) {
                Q(!0, u1.Pulse, t, e, a);
            },
